...
- **Off by default** — it is the only scheduled thing that costs money every day whether or not anything was published. Toggle, time, "Fetch now" (build without sending) and "Send now" live in Settings → Reminders & follow-ups, with the last week's digests folded underneath.
